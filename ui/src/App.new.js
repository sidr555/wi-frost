...
function App() {
    ...
    const { msgs } = useSubscription('wi-frost/state');
...
//        user: "mosquitto",
    ...
    return (
//        <div></div>
//         <Connector brokerUrl="mqtt://192.168.0.41:1883" options={ mqttOpts }>
//        <Connector brokerUrl="mqtt://test.mosquitto.org:1884" options={ mqttOpts }>
...
//        <Connector brokerUrl="mqtt://test.mosquitto.org:1883" options={ mqttOpts }>
